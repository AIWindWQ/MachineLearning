# -*- coding:utf-8 -*-
'''
RandomForest依赖于DecisionTree，本质上来讲，RandomForest = Bagging + DecisionTree
本模块完成基本决策树的创建
'''
...
def build_tree(data):
    ...
    if bestGain > 0:
        ...
        return TreeNode(fea=bestCriteria[0], value=bestCriteria[1], \
                    right=right, left=left)
    else:
        return TreeNode(results=label_uniq_cnt(data))  # 返回当前的类别标签作为最终的类别标签
